...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-4 pb-5 border-b border-b-gray-400'>
      ...
      <div  className='flex item-center gap-4'>
        ...
        <div className={`${showMenu ? "fixed  w-full" : "h-0 w-0"} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
          ...
          <ul onClick={()=> setShowMenu(false)} className='flex flex-col items-center font-medium gap-2 mt-5 px-5 text-lg'>
